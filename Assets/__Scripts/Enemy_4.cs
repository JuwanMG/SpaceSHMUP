...
Projectile p = other.GetComponent<Projectile>();
                ...
                // This stops the player from shooting them before they are
        ...
        bounds.center = transform.position + boundsCenterOffset;
                ...
                // Because there was a collision, we’re guaranteed that there is
                ...
                { // If prtHit wasn’t found
                  ...
                  // contacts[0] will be the ProjectileHero instead of the
                ...
                foreach (Part prt in parts)
                {
                    ...
                    { // If a part still exists
                        ...
                        break; // and break out of the foreach
